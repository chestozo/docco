...
(function() {
  ...
  highlight = function(source, sections, callback) {
    var colors, language, output, pygments, section;
    language = get_language(source);
    ...
    colors = [
      {
        test: /TODO/g,
        replacer: '<span style="background: #FFFFCC"> TODO </span>'
      }, {
        test: /FIXME/g,
        replacer: '<span style="background: #FFD6D6"> FIXME </span>'
      }, {
        test: /NOTE/g,
        replacer: '<span style="background: #BFF5FB"> NOTE </span>'
      }
    ];
    ...
    pygments.addListener('exit', function() {
      var fragments, i, sc, section, _i, _j, _len, _len1;
  ...
  if (sources.length) {
    ensure_directory('docs', function() {
      var files, index_html, index_template, next_file;
